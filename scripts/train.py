...
from asvloc.training import train_asvloc
...
def main() -> None:
    ...
    ``asvloc/training/train.py::train_asvloc``.
    """
    parser = argparse.ArgumentParser(description="Train the final ASVLoc architecture.")
